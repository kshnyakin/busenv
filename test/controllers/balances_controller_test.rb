...
class BalancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create balance" do
    assert_difference('Balance.count') do
      post balances_url, params: { balance: { amount: @balance.amount, user_id: @balance.user_id } }
    end
  ...
  test "should update balance" do
    patch balance_url(@balance), params: { balance: { amount: @balance.amount, user_id: @balance.user_id } }
